                          ...
                          onStepContinue: () async {
                            ...
                            if (isLastStep) {
                              try {
                                ...
                                //         255, 186, 118, 113),
                                //     content: Text(student.imageData.toString()),
                                //   ),
                                // );
                                // createpdf();
                                ...
                                //           255, 186, 118, 113),
                                //       content:
                                //           Text(student.imageData.toString()),
                                //     ),
                                //   );
                                // }
                                await FirebaseHelper()
                                    .addStudentRegistration(student)
                                    .then((value) => createpdf());
        ...
        content: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text(student.imageData != null
                  ? 'Selected: $filename'
                  : 'Select file'),
            ),
          ],
    ...
    filePickerInput.onChange.listen((event) {
      ...
      if (files!.isNotEmpty) {
        ...
        reader.onLoadEnd.listen((event) {
          setState(() {
            filename = file.name;
            student.imageData = reader.result as Uint8List?;
          });
        });
